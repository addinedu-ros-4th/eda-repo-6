...
<br/>
#
<img src = "https://github.com/yjs126/local_project/assets/156267935/0f9de31e-1369-42cd-a065-f98f11d2dd58"><br/>
<br/>
...
<br/>
1) 2021년 서울시 자치구별 아파트 실거래 매매가 평균<br/>
데이터는 서울시 구별 통계자료를  **Pandas**의 **DataFrame**를 이용해서 정리하였고,<br/>
지도는 서울시 자치구별 **json**파일을 이용해 **Folium** 라이브러리를 사용하여 데이터를 구별로 나타내었다.<br/>
<img src = "https://github.com/addinedu-ros-4th/eda-repo-6/assets/156267892/00cc4b72-08c3-41b5-979f-7932cd92f571"><br/>
강남구, 서초구, 용산구 등의 집값이 압도적으로 높은 것을 데이터로 확인되었다.
<br/>
<br/>
2) 2021년 서울시 자치구별 종사자 수<br/>
<img src = "https://github.com/addinedu-ros-4th/eda-repo-6/assets/156267892/1f137e9b-7d67-421e-a513-11116106facd"><br/>
강남구 종사자수가 제일 많았고,<br/>
강남3구(서초구,강남구,송파구)로 확인해봐도 1,2,4순위로 많았다.
<br/>
<br/>
3) 2021년 서울시 자치구별 평균 근로소득 (근무지기준)<br/>
<img src = "https://github.com/addinedu-ros-4th/eda-repo-6/assets/156267892/7f89e751-a493-4515-8b25-42e65b2d36d9"><br/>
강남3구(서초,강남,송파)가 제일 일자리가 많았지만,<br/>
평균연봉으로 확인했을 때는 종로,영등포,중구가 강남3구 보다 높았다.
<br/>
<br/>
4) 2021년 서울시 자치구별 평균 근로소득 (거주지기준)<br/>
<img src = "https://github.com/addinedu-ros-4th/eda-repo-6/assets/156267892/6c040365-dca0-4750-8b25-7e58575ef576"><br/>
거주지 기준으로는 강남,서초,용산이 다른구 보다 훨씬 더 많은 평균연봉을 벌고 있고,<br/>
근무지 기준으로 높았던 종로,영등포,중구는 의외로 높게 나오진 않았다.<br/>
